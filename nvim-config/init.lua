...
-- Exit terminal mode and go to left window (useful for claudecode.nvim)
...
-- Black hole register for deleting
...
-- Horizontal split
vim.api.nvim_set_keymap('n', '<Leader>t-', ':split<CR>', { noremap = true, silent = true })
-- Vertical split
vim.api.nvim_set_keymap('n', '<Leader>t|', ':vsplit<CR>', { noremap = true, silent = true })
-- Close split
vim.api.nvim_set_keymap('n', '<Leader>t;', ':close<CR>', { noremap = true, silent = true })
